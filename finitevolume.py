...
def main():
    ...
    while t < tEnd:
        ...
        # logger("getGradient Return", rho_dx, RHO + "dx")
        # logger("getGradient Return", rho_dy, RHO + "dy")
        # logger("getGradient Return", vx_dx, VX + "dx")
        # logger("getGradient Return", vx_dy, VX + "dy")
        # logger("getGradient Return", vy_dx, VY + "dx")
        # logger("getGradient Return", vy_dy, VY + "dy")
        # logger("getGradient Return", P_dx, P_ + "dx")
        # logger("getGradient Return", P_dy, P_ + "dy")
...
def logger(functionName, value, varName):
    print(f"[DEBUG]-[From Function {functionName}]")
    print(varName)
    print(value)
